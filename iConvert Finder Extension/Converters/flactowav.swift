...
class FLACtoWAVConverter {
    private let logger = OSLog(subsystem: "at.untitledapps.iConvert", category: "FLACtoWAV")

    func convert(_ sourceURL: URL) -> Bool {
        os_log("Converting FLAC to WAV: %{public}@", log: logger, type: .info, sourceURL.path)
