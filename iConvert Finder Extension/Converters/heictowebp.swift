...
class HEICtoWebPConverter {
    private let logger = OSLog(subsystem: "at.untitledapps.iConvert", category: "HEICtoWebP")

    func convert(_ sourceURL: URL) -> Bool {
        os_log("Converting HEIC to WebP: %{public}@", log: logger, type: .info, sourceURL.path)
