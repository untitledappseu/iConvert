...
class JPGtoHEICConverter {
    private let logger = OSLog(subsystem: "at.untitledapps.iConvert", category: "JPGtoHEIC")

    func convert(_ sourceURL: URL) -> Bool {
        os_log("Converting JPG to HEIC: %{public}@", log: logger, type: .info, sourceURL.path)
